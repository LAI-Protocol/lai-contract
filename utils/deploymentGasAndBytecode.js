...
const LAOStaking = artifacts.require("./LAO/LAOStaking.sol")
const LAOToken = artifacts.require("./LAO/LAOToken.sol")
const LockupContractFactory = artifacts.require("./LAO/LockupContractFactory.sol")
const CommunityIssuance = artifacts.require("./LAO/CommunityIssuance.sol")
const HintHelpers = artifacts.require("./HintHelpers.sol")

const CommunityIssuanceTester = artifacts.require("./LAO/CommunityIssuanceTester.sol")
...
async function main() {
  ...
  const LAOContracts = await dh.deployLAOContractsHardhat(ARBITRARY_ADDRESS, ARBITRARY_ADDRESS,ARBITRARY_ADDRESS)
  ...
  console.log(`\n`)
  console.log(`LAO CONTRACTS`)
  await logContractDeploymentCosts(LAOContracts)
  console.log(`\n`)
  logContractBytecodeLengths(LAOContractABIs)
  console.log(`\n`)
