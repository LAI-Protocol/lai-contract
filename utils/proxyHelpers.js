...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawLAI(...params) {
    return this.forwardFunction(params, 'withdrawLAI(uint256,uint256,address,address)')
  }

  async repayLAI(...params) {
    return this.forwardFunction(params, 'repayLAI(uint256,address,address)')
  }
  ...
  async LAI_GAS_COMPENSATION(...params) {
    return this.proxyFunction('LAI_GAS_COMPENSATION', params)
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingLAIDebtReward(...params) {
    return this.proxyFunction('getPendingLAIDebtReward', params)
  }
  ...
  async L_LAIDebt() {
    return this.proxyFunction('L_LAIDebt', [])
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedLAIDeposit(user) {
    return this.proxyFunctionWithUser('getCompoundedLAIDeposit', user)
  }
...
class LAOStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token)
  }
  ...
  async F_LAI(user) {
    return this.proxyFunctionWithUser('F_LAI', user)
  }
}
