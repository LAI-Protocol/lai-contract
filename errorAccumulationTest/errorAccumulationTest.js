...
contract('TroveManager', async accounts => {
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    LAIDebt left in Default Pool is: 108
    ...
    LAIDebt left in Default Pool is: 653
  */
  ...
  /* ABDK64, no error correction:
    ...
    LAIDebt left in Default Pool is: 75 
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    LAIDebt left in Default Pool is: 180 
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    let totalLAIDebtPoolDifference = web3.utils.toBN(0)

    for (account of accounts.slice(1, 11)) {
      const activePoolETH = await activePool.getETH()
      const activePoolLAIDebt = await activePool.getLAI()
      ...
      totalLAIDebtPoolDifference.add(activePoolLAIDebt.sub(defaultPoolLAIDebt))
    }
    
    console.log(`Accumulated ETH difference between Default and Active Pools is: ${totalETHPoolDifference}`)
    console.log(`Accumulated LAIDebt difference between Active and Default Pools is: ${totalLAIDebtPoolDifference}`)
  })
  
  /* ABDK64, no error correction
    Accumulated ETH difference between Default and Active Pools is: 0
    Accumulated LAIDebt difference between Active and Default Pools is: 0
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const totalLAIRewards = (totalColl.mul(L_LAIDebt)).div(_1e18_BN)

    const defaultPoolETH = await defaultPool.getETH()
    const defaultPoolLAIDebt = await defaultPool.getLAIDebt()

    const ETHRewardDifference = defaultPoolETH.sub(totalETHRewards)
    const LAIDebtRewardDifference = defaultPoolLAIDebt.sub(totalLAIRewards)

    console.log(`ETH difference between total pending rewards and DefaultPool: ${ETHRewardDifference} `)
    console.log(`LAIDebt difference between total pending rewards and DefaultPool: ${LAIDebtRewardDifference} `)
  })

  /* ABDK64, no error correction:
    ETH difference between total pending rewards and DefaultPool: 700
    LAIDebt difference between total pending rewards and DefaultPool: 800

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    LAIDebt difference between total pending rewards and DefaultPool: 400
    
    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: -100
    LAIDebt difference between total pending rewards and DefaultPool: -200

    Pure division with correction: 
    ETH difference between total pending rewards and DefaultPool: 0
    LAIDebt difference between total pending rewards and DefaultPool: 0
  */
  ...
  /* ABDK64, no error correction:
    ...
    LAIDebt difference between total pending rewards and DefaultPool: 55000
    
    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31000
    LAIDebt difference between total pending rewards and DefaultPool: 31000

    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: 2000
    LAIDebt difference between total pending rewards and DefaultPool: -2000
 ...
 it("11 accounts with random ETH and proportional LAI (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })

  await th.openTrove_allAccounts_randomETH_ProportionalLAI(1, 2, accounts.slice(0, 11), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    LAIDebt difference between total pending rewards and DefaultPool: 8000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    LAIDebt difference between total pending rewards and DefaultPool: 300
    ...
    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 100
    LAIDebt difference between total pending rewards and DefaultPool: 100
  */

  it("101 accounts with random ETH and proportional LAI (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(1000, 'ether') })

    await th.openTrove_allAccounts_randomETH_ProportionalLAI(1, 2, accounts.slice(0, 101), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    LAIDebt difference between total pending rewards and DefaultPool: 61000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31300
    LAIDebt difference between total pending rewards and DefaultPool: 30000
    ...
    LAIDebt difference between total pending rewards and DefaultPool: 1000
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
   // Acct 99 opens trove with 100 LAI
    await borrowerOperations.openTrove(0, 0,  accounts[99], { from: accounts[99], value: dec(100, 'ether') })
    await borrowerOperations.withdrawLAI(0, dec(100, 18), accounts[99], {from: accounts[99]})
    ...
    // On loop: Account[99] adds 10 LAI to pool -> a trove gets liquidated and partially offset against SP, emptying the SP
    for (account of accounts.slice(1, 11)) {
    ...
    const totalLAIRewards_Distribution = (totalColl.mul(L_LAIDebt)).div(_1e18_BN)

    const defaultPoolETH = await defaultPool.getETH()
    const defaultPoolLAIDebt = await defaultPool.getLAIDebt()

    const ETHRewardDifference = defaultPoolETH.sub(totalETHRewards_Distribution)
    const LAIDebtRewardDifference = defaultPoolLAIDebt.sub(totalLAIRewards_Distribution)

    console.log(`ETH difference between total pending distribution rewards and DefaultPool: ${ETHRewardDifference} `)
    console.log(`LAIDebt difference between total pending distribution rewards and DefaultPool: ${LAIDebtRewardDifference} `)
  })

  /* ABDK64, no error correction
    ETH difference between total pending distribution rewards and DefaultPool: 550
    LAIDebt difference between total pending distribution rewards and DefaultPool: 600
    
    DeciMath, no error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 150
    LAIDebt difference between total pending distribution rewards and DefaultPool: -200
    
    Pure division with error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 50
    LAIDebt difference between total pending distribution rewards and DefaultPool: 0
  */

  it("101 accounts. 100 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    // Acct 99 opens trove with 100 LAI
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawLAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
  ...
  /* ABDK64, no error correction
    ...
    LAIDebt difference between total pending distribution rewards and DefaultPool: 8900
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    /* Sometimes, the error causes the last LAI withdrawal from SP to underflow and fail. 
    ...
    const SP_LAI = await stabilityPool.getTotalLAIDeposits()  

    const SP_LAI_Insufficiency = web3.utils.toBN(whaleSPDeposit).sub(SP_LAI)

     // check Stability Pool
    console.log(`Surplus ETH left in in Stability Pool is ${SP_ETH}`)
    console.log(`LAI insufficiency in Stability Pool is ${SP_LAI_Insufficiency}`)
   })

   /* ABDK64, no error correction
      Sometimes subtraction overflows on last withdrawal from SP - error leaves insufficient LAI in Pool.
      ...
      LAI insufficiency in Stability Pool is 530
      
      DeciMath, no error correction:
      Surplus ETH left in in Stability Pool is 0
      LAI insufficiency in Stability Pool is 0
   ...
   /* ABDK64, no error correction
    ...
    LAI insufficiency in Stability Pool is 5300
   ...
   */
   ...
   it("11 accounts. 10 Borrowers add to SP, random LAI amounts. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 LAI
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawLAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
   ...
   /* ABDK64, no error correction
      ...
      LAI insufficiency in Stability Pool is 442
      ...
      LAI insufficiency in Stability Pool is 67

      Pure division with error correction:
      Surplus ETH left in in Stability Pool is 446
      LAI insufficiency in Stability Pool is 507
    */

   it("101 accounts. 100 Borrowers add to SP, random LAI amounts. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 LAI
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawLAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
   ...
   /* ABDK64, no error correction
    ...
    LAI insufficiency in Stability Pool is 1112

    DeciMath, no error correction:
    Surplus ETH left in in Stability Pool is 1373
    LAI insufficiency in Stability Pool is -13

    Pure division with no error correction:
    Surplus ETH left in in Stability Pool is 4087
    LAI insufficiency in Stability Pool is 1960

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 3072
    LAI insufficiency in Stability Pool is 452
  */ 

 it("501 accounts. 500 Borrowers add to SP, random LAI amounts. 1 liquidation, 500 Borrowers withdraw all their SP funds", async () => {
  // Acct 99 opens trove with 100 LAI
   await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })
   await borrowerOperations.withdrawLAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
  ...
  /* ABDK64, no error correction:
    ...
    LAI insufficiency in Stability Pool is -8445

    Pure division, no correction:
    Surplus ETH left in in Stability Pool is 18708
    LAI insufficiency in Stability Pool is 25427

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 1573
    LAI insufficiency in Stability Pool is 6037
  */ 
...
/* DeciMath:
  ...
  LAIDebt left in Default Pool is: 308731912

  Pure division, correction:
  ETH left in Default Pool is: 1136050360
  LAIDebt left in Default Pool is: 997601870

  Pure division, no correction:
  ETH left in Default Pool is: 810899932
  LAIDebt left in Default Pool is: 535042995
*/
...
it("101 accounts with random large coll, magnitude ~1e8 ether. 1 liquidation. 500 accounts do a Trove operation (apply rewards)", async () => {
 ...
 /*
  ...
  LAIDebt left in Default Pool is: 14696382412

  Pure division, correction:
  ETH left in Default Pool is: 9281255535
  LAIDebt left in Default Pool is: 5854012464
  */
...
it("11 accounts with random ETH and proportional LAI (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  ...
  // Troves open with 100-200 million ether and proportional LAI Debt
  await th.openTrove_allAccounts_randomETH_ProportionalLAI(100000000, 200000000, accounts.slice(0, 11), contracts, 180)
...
/* 
  ...
  LAIDebt difference between total pending rewards and DefaultPool: 12000000000

  Pure division with correction:
  ETH difference between total pending rewards and DefaultPool: 1000000000
  LAIDebt difference between total pending rewards and DefaultPool: 1000000000
  */
  ...
  it("101 accounts with random ETH and proportional LAI (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    ...
    // Troves open with 100-200 million ether and proportional LAI Debt
    await th.openTrove_allAccounts_randomETH_ProportionalLAI(100000000, 200000000, accounts.slice(0, 101), contracts, 180)
  ...
  /*
    ...
    LAIDebt difference between total pending rewards and DefaultPool: 870000000000

    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 10000000000
    LAIDebt difference between total pending rewards and DefaultPool: 10000000000
  */
})
 ...
 Test to see if error is stable or grows. 
  ...
  1) Reward applications accumulate ETH and LAIDebt error in DefaultPool

  2) Liquidations accumulate ETH and LAIDebt error in DefaultPool
  ...
  5) StabilityPool Withdrawals can accumulate LAILoss in the StabilityPool (i.e. they distribute too much LAI), and can block
